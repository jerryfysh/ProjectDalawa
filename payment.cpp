...

{
    ...
    float amount, day, year;
    float statetax, avgtax, levy;
    float payment;
    ...
    if (statename != "Alabama" && statename != "Alaska" && statename != "Arizona"
        && statename != "California" && statename != "Colorado" && statename != "Connectitcut" 
        && statename != "Delaware"&& statename != "Florida"&& statename != "Georgia"
        && statename != "Hawaii" && statename != "Idaho"&& statename != "Illinois"
        && statename != "Indiana"&& statename != "Iowa"&& statename != "Kansas"
        && statename != "Kentucky"&& statename != "Louisiana"&& statename != "Maine"
        && statename != "Maryland"&& statename != "Massachusetts"&& statename != "Michigan"
        && statename != "Minnesota" && statename != "Mississippi"&& statename != "Missouri"
        && statename != "Montana" && statename != "Nebraska"&& statename != "Nevada"
        && statename != "New Hampshire"&& statename != "New Jersey"&& statename != "New Mexico"
        && statename != "New York"&& statename != "North Carolina"&& statename != "North Dakota"
        && statename != "Ohio"&& statename != "Oklahoma"&& statename != "Oregon"
        && statename != "Pennsylvania"&& statename != "Rhode Island"&& statename != "South Carolina"
        && statename != "South Dakota"&& statename != "Tennessee"&& statename != "Texas"
        && statename != "Utah" && statename != "Vermont" && statename != "Virginia"
        && statename != "Washington" && statename != "West Virginia" && statename != "Wisconsin"
        && statename != "Wyoming") {
    ...
    if (statename == "Massachusetts" && month == "August" && day >= 14 && day <= 20) {
            payment = amount;
            cout << fixed;
            cout.precision(2);
            cout << "Please pay a total of $" << payment << endl;
